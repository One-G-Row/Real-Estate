                  ...
                  <div className="col-xxl-7 col-md-6 d-flex wow fadeInLeft">
                     <div className="block-one w-100 h-100">
                        <div className="position-relative z-1 h-100">
                           <h3 className="mb-55">Secure a home for your family.</h3>
                           ...
                           <div className="card-box text-center">
                              ...
                              <p className="fs-20">Years Experience <br />with happy clients</p>
                           </div>
                     ...
                     <div className="block-two">
                        <div className="bg-wrapper">
                           ...
                           <ul className="list-style-one fs-22 color-dark style-none">
                              <li>Loan & low Interest facilities</li>
                              <li>Over 100k+ properties & update regularly</li>
                           ...
                           <div className="d-inline-flex flex-wrap align-items-center mt-15 md-mt-10">
                              ...
                              <Link href="/contact" className="min-[320px]:text-center max-[600px]:bg-sky-300"><span>Request a Callback</span> <i className="fa-light fa-arrow-right-long"></i></Link>
                           </div>
                        </div>
                     </div>
                  </div>
